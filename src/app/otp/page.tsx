...
//   // Enhanced useEffect to handle all types of page refresh/navigation
//   useEffect(() => {
//     const handleBeforeUnload = (e: BeforeUnloadEvent) => {
//       // Only show warning if OTP is in progress (has referenceId and timer > 0)
//       if (referenceId && timer > 0 && !isVerified) {
//         e.preventDefault();
...
//       // Prevent all common refresh shortcuts
//       const isRefreshShortcut = 
//         e.key === 'F5' || 
//         (e.ctrlKey && e.key === 'r') || 
//         (e.ctrlKey && e.shiftKey && e.key === 'R') ||
//         (e.metaKey && e.key === 'r'); // For Mac users (Cmd+R)
...
//       // Show modal when page becomes visible after a refresh attempt
//       if (document.visibilityState === 'visible' && referenceId && timer > 0 && !isVerified) {
//         setShowRefreshWarning(true);
//       }
//     };
...
//               Refreshing the page will invalidate your current OTP session. You'll need to request a new OTP. Are you sure you want to continue?
//             </p>
//             <div className="flex gap-3">
//               <button
//                 onClick={() => setShowRefreshWarning(false)}
//                 className="flex-1 px-4 py-2 bg-gray-200 rounded hover:bg-gray-300 transition cursor-pointer"
//               >
//                 Cancel
//               </button>
//               <button
...
//                   // Redirect to previous page or home instead of refresh
//                   router.push('/forgot-password-phone');
//                 }}
//                 className="flex-1 px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600 transition cursor-pointer"
//               >
//                 Continue
//               </button>
//             </div>
