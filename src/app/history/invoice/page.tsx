...
function InvoicePageContent() {
  ...
  const generatePDF = (invoice: InvoiceData, buyerType: string) => {
    ...
    const docDefinition: any = {
      // ... (your existing docDefinition)

      // Use the base64 data URL directly in the image definition
      content: [
        // ... your content
        {
          columns: [
            ...
            [
              ...
              { image: logoBase64, width: 80, alignment: 'right', margin: [80, 0, 0, 0] }
            ]
          ],
          columnGap: 16,
          margin: [0, 0, 0, 8]
      ...
      // Remove the images dictionary since we're using the data URL directly
      // images: { logo: logoBase64 || '' }, // REMOVE THIS LINE
    };
