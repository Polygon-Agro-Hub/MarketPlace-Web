...
const Page: React.FC = () => {
    ...
    const [phone1, setPhone1] = useState('7700000000');
    const [phone2, setPhone2] = useState('7700000000');
            ...
            <div className='flex flex-col lg:flex-row lg:items-start gap-4 sm:gap-6 items-start mt-6 '>
                ...
                <div className='w-full min-h-[1100px] lg:w-2/3  bg-white p-4 sm:p-5 md:p-6 rounded-lg shadow-md border border-gray-300'>
                    ...
                    <div className='flex flex-row md:gap-4 gap-2 mb-6'>
                        ...
                        <div className="w-2/9 md:w-1/9">
                            <label className='block font-semibold mb-1 text-[#2E2E2E]'>Title *</label>
                        ...
                        <div className="w-7/9 md:w-8/9">
                            <label className='block font-semibold mb-1 text-[#2E2E2E]'>Full name *</label>
                            <input
                                type="text"
                ...
                <div className='w-full lg:w-1/3 mt-6 lg:mt-0'>
                    <div className='border border-gray-300 rounded-lg shadow-md p-4 sm:p-5 md:p-6'>
                        ...
                        <button className='w-full bg-purple-800 text-white font-semibold rounded-lg px-4 py-3 hover:bg-purple-900 transition-colors'>
                            Continue to Payment
                        </button>
                    </div>
                </div>
